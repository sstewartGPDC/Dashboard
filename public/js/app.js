...
const DASHBOARD_TEMPLATES = [
  {
    ...
    cards: [
      ...
      { id: 't4b', type: 'kpi', title: 'Custody Rate', width: 'small', field: 'custodyRate', icon: 'percent', format: 'percent', subtitle: 'Clients in custody (case-weighted)' },
      { id: 't4c', type: 'kpi', title: 'Conflict Rate', width: 'small', field: 'conflictRate', icon: 'percent', format: 'percent', subtitle: 'Cases referred to conflict' },
