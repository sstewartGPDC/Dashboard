...
CREATE TABLE IF NOT EXISTS templates (
  ...
  kind TEXT NOT NULL DEFAULT 'metric',         -- 'metric' (numeric per-circuit) | 'roster' (employee list)
...
-- Employee roster rows: many people per circuit, refreshed on a cadence
-- (monthly). Carries its own period columns so it stays fully decoupled from
-- the numeric circuit_data / upload_history model.
